...
class PyramidFeatures(nn.Module):
    def __init__(self, C3_size, C4_size, C5_size, feature_size=256):
        ...
        # upsample C5 to get P5 from the bottom up pathway to the top down pathway.
...
class ResNet(nn.Module):
    ...
    def forward(self, img_batch):
        ...
        x1 = self.layer1(x)
        print("Layer 1 out:", x1.shape)
        x2 = self.layer2(x1)
        print("Layer 2 out:", x2.shape)
        x3 = self.layer3(x2)
        print("Layer 3 out:", x3.shape)
        x4 = self.layer4(x3)
        print("Layer 4 out:", x4.shape)
        ...
        #print("Clasification out:", classification.shape)
        ...
        if self.training:
            ...
            #scores_over_thresh = (scores>0.02)[0, :, 0]
